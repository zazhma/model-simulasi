...
<html lang="en">
  ...
  <head>
    ...
    <title>PEGADAIAN BUKIT BESTARI</title>
  </head>
  <body>
...
<br><br><br><br<><br>
    <div>
      <div class="jumbotron">
        <div class="container">
          <h3 class="display-5 text-center"><b><marquee>Selamat Datang di Sistem Informasi Antrian Via WhatsApp Pegadaian Bukit Bestari</marquee></b></h3>
        </div>
      </div>
    </div>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block" src="http://localhost/dbpegadaian/readapi/layout/css/gambar/test.jpg" alt="First slide">
          ...
          <div class="carousel-item">
            <img class="d-block" src="http://localhost/dbpegadaian/readapi/layout/css/gambar/test2.jpg" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
              <h5></h5>
              <p></p>
            </div>
          ...
          <div class="carousel-item">
            <img class="d-block" src="http://localhost/dbpegadaian/readapi/layout/css/gambar/test3.jpg" alt="Third slide">
